...
if __name__=="__main__":
    ...
    trainingFile    = '/usera/anthony/tmp/ExampleSVMTrainingSet.txt'
    svmName         = 'ExampleSVM'
    kernelType      = 'poly' # poly, rbf, linear
    kernelDegree    = 3      # only for poly kernel
    cValue          = 1.0    # default 1.0
    gammaValue      = 0.015  # default 1/n_features
    coef0Value      = 1.0    # default 1.0
    
    serializeToPkl  = True
    serializeToXml  = True
    loadFromPkl     = False
    xmlFileName     = 'SVM_model.xml'
    pklFileName     = 'SVM_model.pkl'
